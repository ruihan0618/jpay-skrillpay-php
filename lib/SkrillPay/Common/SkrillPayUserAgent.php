...
/**
 * Class SkrillPayUserAgent
 * SkrillPayUserAgent generates User Agent for curl requests
 *
...
class SkrillPayUserAgent
{
    ...
    public static function getValue($sdkName, $sdkVersion)
    {
        ...
        return sprintf("SkrillPaySDK/%s %s (%s)", $sdkName, $sdkVersion, implode('; ', $featureList));
    }
