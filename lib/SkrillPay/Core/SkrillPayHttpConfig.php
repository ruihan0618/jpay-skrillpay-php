...
class SkrillPayHttpConfig
{
     ...
     * These are typically overridden by SkrillPayConnectionManager
     *
     * @var array
     */
    ...
    public function setHttpProxy($proxy)
    {
        ...
        if ($urlParts == false || !array_key_exists("host", $urlParts)) {
            throw new SkrillPayConfigurationException("Invalid proxy configuration " . $proxy);
        }
