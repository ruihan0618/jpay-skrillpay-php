...
use SkrillPay\Exception\SkrillPayConnectionException;
 ...
 */
class SkrillPayHttpConnection
{

    /**
     * @var SkrillPayHttpConfig
     */
    private $httpConfig;
     ...
     */
    public function __construct(SkrillPayHttpConfig $httpConfig, array $config)
    {
        if (!function_exists("curl_init")) {
            throw new SkrillPayConfigurationException("Curl module is not available on this system");
        }
     ...
     * @return mixed
     * @throws SkrillPayConnectionException
     */
    public function execute($data)
    {
        ...
        if (curl_errno($ch)) {
            $ex = new SkrillPayConnectionException(
