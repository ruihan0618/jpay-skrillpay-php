...
/**
 * Class SkrillPayCredentialManager
 *
 * SkrillPayCredentialManager holds all the credential information in one place.
 *
...
class SkrillPayCredentialManager
{
     ...
     * Singleton Object
     *
     * @var SkrillPayCredentialManager
     */
     ...
     * @return SkrillPayCredentialManager
     */
    public static function getInstance($config = null)
    {
        if (!self::$instance) {
            self::$instance = new self($config == null ? SkrillPayConfigManager::getInstance()->getConfigHashmap() : $config);
        }
    ...
    public function getCredentialObject($userId = null)
    {
        ...
        if (empty($credObj)) {
            throw new SkrillPayInvalidCredentialException("Credential not found for " .  ($userId ? $userId : " default user") .
